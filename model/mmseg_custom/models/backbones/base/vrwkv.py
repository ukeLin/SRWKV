...
_cuda_dir = os.path.join(_current_dir, 'cuda_new')
wkv_cuda = load(name="bi_wkv", sources=[os.path.join(_cuda_dir, "bi_wkv.cpp"), os.path.join(_cuda_dir, "bi_wkv_kernel.cu")],
...
# @BACKBONES.register_module()  # 注释掉以避免与 mmcls_custom 中的 VRWKV 冲突
